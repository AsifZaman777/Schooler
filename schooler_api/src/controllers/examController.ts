...
export const getAllExams = asyncHandler(async (req: Request, res: Response) => {
    ...
    const { courseId, classRoomId, examType, status, startDate, endDate } = req.query;
...
// Exam Marks
export const createExamMark = asyncHandler(async (req: Request, res: Response) => {
...
export const getAllExamMarks = asyncHandler(async (req: Request, res: Response) => {
    const { page, limit, sortBy, sortOrder } = getPaginationParams(req.query);
...
export const getExamMarkById = asyncHandler(async (req: Request, res: Response) => {
...
export const updateExamMark = asyncHandler(async (req: Request, res: Response) => {
...
export const deleteExamMark = asyncHandler(async (req: Request, res: Response) => {
...
export const getStudentExamResults = asyncHandler(async (req: Request, res: Response) => {
