...
export const getAllRoutines = asyncHandler(async (req: Request, res: Response) => {
...
export const getRoutineByClassRoom = asyncHandler(async (req: Request, res: Response) => {
...
export const getRoutineByTeacher = asyncHandler(async (req: Request, res: Response) => {
    const routines = await Routine.find({
