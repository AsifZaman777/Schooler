...
import { createRoutineSchema, updateRoutineSchema } from '../validators/schemas';

const router = Router();

router.post('/', validateRequest(createRoutineSchema), routineController.createRoutine);
...
router.put('/:id', validateRequest(updateRoutineSchema), routineController.updateRoutine);
